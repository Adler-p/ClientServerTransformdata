		...
		try {
			...
			while(!input_filename.equals("exit()")){
				try{
					...
					byte[] encrypt_filename_bytes = RSAKeyUtils.encrypt_bytes(filename_bytes, serverPublicKey);
...
//					System.out.println(filename_bytes.length);
					...
					for (boolean fileEnded = false; !fileEnded;) {
						...
						byte [] encrypt_fromfilebuffer = RSAKeyUtils.encrypt_bytes(fromFileBuffer, serverPublicKey);
					...
					//System.out.println("times written: " +times_written);
